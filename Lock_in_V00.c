...
/**
  ...
  * O código retorna o valor do Módulo e do ângulo do sinal medido.
  *
  * Geração de Sinal Senoidal de Referência com 128 Pontos e 200 Hz.
  * Resolução do DAC de 12 bits.
  * 4095 equivale a 3,3V.
  * TIM8 conta de 0 a 4687. Quando passa em 790, aciona a leitura analógica.
  * Quando estoura, atualiza o DAC com o próximo valor da LUT.
  *
...
#define Ns 128
#define Periodos 10		// Qntd de períodos a ser processado.
...
// Cálculo primeiro harmônico: Sinal em Fase
...
for (i = 0; i < (Periodos*Ns); i++){
	...
	fase1h =  soma/(Periodos*Ns);
	soma = 0;

// Cálculo primeiro harmônico: Sinal em Quadratura
for (i = 0; i < (Periodos*Ns); i++){
